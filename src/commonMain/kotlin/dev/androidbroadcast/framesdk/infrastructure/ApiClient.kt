package dev.androidbroadcast.framesdk.infrastructure
...
import dev.androidbroadcast.framesdk.auth.*
...
open class ApiClient(
    ...
    private val authentications: kotlin.collections.Map<String, Authentication> by lazy {
        mapOf(
                ...
                "DeveloperToken" to HttpBearerAuth("bearer"), 
                "OAuth2" to OAuth(), 
                "OAuth2" to OAuth(), 
                "C2CDeviceAuth" to OAuth(), 
                "C2COAuth2" to OAuth())
    }

    companion object {
        const val BASE_URL = "https://api.frame.io"
