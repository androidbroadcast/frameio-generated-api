...
class AddCollaboratorToProjectRequestTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of AddCollaboratorToProjectRequest
        //val modelInstance = AddCollaboratorToProjectRequest()
