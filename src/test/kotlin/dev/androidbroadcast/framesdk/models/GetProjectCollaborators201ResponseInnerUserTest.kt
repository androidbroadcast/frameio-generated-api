...
class GetProjectCollaborators201ResponseInnerUserTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of GetProjectCollaborators201ResponseInnerUser
        //val modelInstance = GetProjectCollaborators201ResponseInnerUser()
        ...
        // to test the property `projectRole`
        should("test projectRole") {
            // uncomment below to test the property
            //modelInstance.projectRole shouldBe ("TODO")
        }
